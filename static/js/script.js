const quizData = {
  it: [
    ...
    {
      question:
        'C 언어에서 변수의 값을 교환하기 위해 사용하는 임시 변수의 역할은?',
    ...
    {
      question:
        '정보처리기능사 시험에서 다루는 전자계산기의 기본 구성 요소 중 하나는?',
    ...
    {
      question:
        "데이터베이스에서 트랜잭션의 ACID 속성 중 '원자성'은 무엇을 의미하는가?",
      options: [
        '모든 작업이 완료되거나 전혀 실행되지 않음',
        '데이터 무결성 유지',
        '동시 접근 제어',
        '영구적 저장 보장',
      ],
    ...
    {
      question:
        '엑셀에서 특정 값을 검색하여 해당 행의 데이터를 반환하는 함수는?',
    ...
    {
      question:
        '데이터베이스에서 3NF(제3정규형)를 만족하기 위한 조건은 무엇인가?',
      options: [
    ...
    {
      question:
        '네트워크에서 OSPF(Open Shortest Path First) 프로토콜의 주요 특징은 무엇인가?',
      options: [
        '거리 벡터 라우팅',
        '링크 상태 라우팅',
        '정적 라우팅',
    ...
    {
      question:
        '운영체제에서 뮤텍스(Mutex)와 세마포어(Semaphore)의 차이점은 무엇인가?',
      options: [
        '뮤텍스는 이진 세마포어와 동일하다',
    ...
    {
      question:
        "엑셀에서 피벗 테이블을 사용하여 데이터를 분석할 때, '계산된 필드'의 기능은 무엇인가?",
      options: [
        '기존 필드의 값을 합산한다',
    ...
    {
      question:
        "데이터베이스에서 트랜잭션의 ACID 속성 중 '고립성(Isolation)'은 무엇을 보장하는가?",
      options: [
    ...
    {
      question:
        '네트워크에서 VPN(Virtual Private Network)의 주요 목적은 무엇인가?',
      options: [
    ...
    {
      question:
        "보안에서 '사회 공학(Social Engineering)' 공격의 특징은 무엇인가?",
      options: [
        '기술적 취약점을 이용한 공격',
        '인간의 심리를 이용하여 정보를 탈취',
        '네트워크를 통한 무차별 대입 공격',
    ...
    {
      question:
        "네트워크에서 'NAT(Network Address Translation)'의 기능은 무엇인가?",
      options: [
    ...
    {
      question:
        "운영체제에서 '데드락(Deadlock)'을 방지하기 위한 방법은 무엇인가?",
      options: [
        '자원 선점 불가 조건 제거',
        '메모리 용량 증가',
        '프로세스 종료',
    ...
    {
      question:
        "네트워크에서 'QoS(Quality of Service)'의 주요 목적은 무엇인가?",
      options: [
        '네트워크 성능을 보장',
        '데이터를 암호화',
        '네트워크 장비를 관리',
    ...
    {
      question:
        '일회용 패스워드로 로그인 할 때마다 일회성 패스워드를 생성하는 보안시스템을 무엇이라 하는가?',
  ...
  sports: [
    ...
    {
      question:
        "공과 네트를 사용해 코트에서 진행되며, 종종 '아름다운 게임'이라 불리는 스포츠는 무엇인가요?",
    ...
    {
      question:
        '수영, 사이클링, 달리기를 하나의 경기에서 진행하는 스포츠는 무엇인가요?',
    ...
    {
      question:
        "브라질과 함께 월드컵 3회 우승을 차지하며 '축구의 왕'으로 알려진 선수는 누구인가요?",
      options: [
        '리오넬 메시',
        '크리스티아누 호날두',
        '펠레',
    ...
    {
      question:
        '운동선수들이 400미터 타원형 트랙을 달리는 스포츠는 무엇인가요?',
    ...
    {
      question:
        '축구 경기에서 한 팀이 필드에 내보낼 수 있는 최대 선수 수는 몇 명인가요?',
      options: ['7', '9', '11', '13'],
      answer: '11',
      difficulty: 'easy',
    },
    ...
    {
      question:
        '야구에서 한 팀이 한 이닝에 공격할 수 있는 아웃카운트는 몇 개인가요?',
      options: ['2', '3', '4', '5'],
      answer: '3',
      difficulty: 'easy',
    },
    ...
    {
      question:
        '스키와 스노보드를 포함하는 겨울 스포츠는 어떤 대회에서 주로 볼 수 있나요?',
    ...
    {
      question:
        '축구에서 오프사이드 규칙이 공식적으로 도입된 시기는 언제인가요?',
    ...
    {
      question:
        '농구에서 한 팀이 한 쿼터에 요청할 수 있는 타임아웃 횟수는 최대 몇 번인가요?',
      options: ['2번', '3번', '4번', '5번'],
      answer: '3번',
      difficulty: 'medium',
    },
    {
      question:
        '테니스 그랜드슬램 대회 중 클레이 코트에서 열리는 대회는 무엇인가요?',
    ...
    {
      question:
        '야구에서 투수가 한 타자에게 연속으로 세 번 스트라이크를 던지면 무엇이라고 하나요?',
    ...
    {
      question:
        '수영에서 4가지 영법(자유형, 배영, 평영, 접영)을 모두 포함하는 경기는 무엇인가요?',
    ...
    {
      question:
        '올림픽에서 남자 축구 금메달을 가장 많이 획득한 국가는 어디인가요?',
    ...
    {
      question:
        '배구에서 서브를 넣은 팀이 즉시 득점하지 않고 공을 주고받는 상황을 무엇이라고 하나요?',
    ...
    {
      question:
        '아이스하키에서 한 팀이 페널티로 인해 선수가 줄어들 때를 무엇이라고 하나요?',
    ...
    {
      question:
        '골프에서 파보다 한 타 적게 홀을 마무리한 경우를 무엇이라고 하나요?',
      options: ['이글', '버디', '파', '보기'],
      answer: '버디',
      difficulty: 'medium',
    },
    ...
    {
      question:
        '테니스에서 한 플레이어가 한 세트에서 모든 게임을 이기는 경우를 무엇이라고 하나요?',
    ...
    {
      question:
        '야구에서 한 시즌에 40홈런과 40도루를 동시에 달성한 기록을 무엇이라고 하나요?',
    ...
    {
      question:
        '농구에서 공을 바닥에 튕기며 이동하는 동작을 무엇이라고 하나요?',
    ...
    {
      question:
        '권투에서 경기 중 선수가 쓰러져 10초 안에 일어나지 못하면 무엇이라고 하나요?',
    ...
    {
      question:
        '축구에서 페널티 킥은 골문에서 몇 미터 떨어진 지점에서 실행되나요?',
    ...
    {
      question:
        '아이스하키에서 정규 경기 시간이 끝난 후 동점을 해결하기 위해 진행되는 시간은 무엇인가요?',
    ...
    {
      question:
        '골프에서 한 홀을 기준 타수보다 두 타 더 많이 친 경우를 무엇이라고 하나요?',
    ...
    {
      question:
        '탁구에서 한 선수가 연속으로 서브를 할 수 있는 횟수는 몇 번인가요?',
      options: ['1번', '2번', '3번', '4번'],
      answer: '2번',
      difficulty: 'medium',
    },
    {
      question:
        '스키 점프 경기에서 점수는 어떤 두 가지 요소를 기준으로 매겨지나요?',
    ...
    {
      question:
        '농구에서 한 선수가 한 경기에서 10점 이상, 10리바운드 이상, 10어시스트 이상을 기록하면 무엇이라고 하나요?',
    ...
    {
      question:
        '테니스에서 한 플레이어가 상대의 서브를 받아 바로 득점하는 샷을 무엇이라고 하나요?',
    ...
    {
      question:
        '야구에서 한 이닝에 양 팀 모두 3아웃을 당하면 이닝이 종료되는데, 이를 몇 번째 아웃이라고 하나요?',
    ...
    {
      question:
        '올림픽에서 체조 경기의 남자 종목 중 하나로, 두 개의 바를 사용하는 경기는 무엇인가요?',
    ...
    {
      question:
        "축구에서 FIFA가 오프사이드 규칙을 수정하여 '수동적 오프사이드' 개념을 명확히 한 연도는 언제인가요?",
    ...
    {
      question:
        '농구에서 NBA 역사상 단일 경기 최다 어시스트 기록을 보유한 선수는 누구인가요?',
    ...
    {
      question:
        '테니스에서 그랜드슬램 단식 타이틀을 가장 많이 획득한 여자 선수는 누구인가요?',
      options: [
        '세리나 윌리엄스',
        '마거릿 코트',
        '슈테피 그라프',
    ...
    {
      question:
        '야구에서 MLB 역사상 한 시즌 최다 세이브 기록을 보유한 투수는 누구인가요?',
      options: [
        '마리아노 리베라',
        '프란시스코 로드리게스',
        '트레버 호프먼',
    ...
    {
      question:
        '수영에서 올림픽 남자 100m 자유형에서 47초대의 기록을 처음 세운 선수는 누구인가요?',
      options: [
        '마이클 펠프스',
        '세자르 시엘루',
        '알랭 베르나르',
    ...
    {
      question:
        '올림픽 역사상 하계 올림픽과 동계 올림픽에서 모두 메달을 획득한 유일한 선수는 누구인가요?',
      options: [
        '에디 이건',
        '클라라 휴스',
        '크리스토프 비겐',
    ...
    {
      question:
        '배구에서 국제 경기에서 리베로 선수가 착용하는 유니폼 색상은 일반적으로 무엇과 달라야 하나요?',
    ...
    {
      question:
        '탁구에서 ITTF가 공식 경기용 공의 직경을 38mm에서 40mm로 변경한 연도는 언제인가요?',
    ...
    {
      question:
        '아이스하키에서 NHL 역사상 한 시즌 최다 골 기록을 보유한 선수는 누구인가요?',
    ...
    {
      question:
        "골프에서 메이저 대회 중 '마스터스'가 열리는 골프 코스의 이름은 무엇인가요?",
    ...
    {
      question:
        'FIFA 월드컵에서 단일 대회 최다 골 기록을 보유한 선수는 누구인가요?',
    ...
    {
      question:
        '테니스에서 한 선수가 모든 그랜드슬램 대회를 같은 해에 우승한 것을 무엇이라고 하나요?',
    ...
    {
      question:
        '야구에서 MLB 역사상 한 경기에서 4홈런을 기록한 최초의 선수는 누구인가요?',
    ...
    {
      question:
        '농구에서 NBA 파이널 MVP 상을 가장 많이 수상한 선수는 누구인가요?',
    ...
    {
      question:
        '올림픽에서 펜싱 종목 중 에페와 플뢰레를 제외한 세 번째 종목은 무엇인가요?',
    ...
    {
      question:
        '권투에서 올림픽 금메달을 획득한 후 프로 세계 챔피언이 된 최초의 한국 선수는 누구인가요?',
    ...
    {
      question:
        '축구에서 UEFA 챔피언스 리그 역사상 한 시즌 최다 골 기록을 보유한 선수는 누구인가요?',
      options: [
        '리오넬 메시',
        '크리스티아누 호날두',
        '라울',
    ...
    {
      question:
        '테니스에서 윔블던 단식 우승자가 받는 트로피의 이름은 무엇인가요?',
      options: [
        '챌린지 컵',
        '비너스 로즈워터 디시',
        '노먼 브룩스 챌린지 컵',
    ...
    {
      question:
        '아이스하키에서 NHL 플레이오프 우승 팀이 받는 트로피는 무엇인가요?',
      options: [
        '캘더 컵',
        '스탠리 컵',
        '프레지던츠 트로피',
    ...
    {
      question:
        '골프에서 PGA 투어 역사상 한 시즌 최다 우승 기록을 보유한 선수는 누구인가요?',
    ...
    {
      question:
        '배구에서 국제 경기에서 한 팀이 한 세트에서 요청할 수 있는 최대 교체 횟수는 몇 번인가요?',
    ...
    {
      question:
        '스키 알파인 경기에서 가장 빠른 속도를 기록하는 종목은 무엇인가요?',
    ...
    {
      question:
        '농구에서 NBA 역사상 한 경기 최다 리바운드 기록을 보유한 선수는 누구인가요?',
    ...
    {
      question:
        '축구에서 월드컵 역사상 단일 경기 최다 관중 기록을 세운 경기는 어느 해의 결승전인가요?',
    ...
    {
      question:
        '테니스에서 그랜드슬램 대회 중 가장 긴 결승전(시간 기준)을 기록한 대회는 무엇인가요?',
      options: [
        '2008년 윔블던',
        '2012년 호주 오픈',
        '2010년 프랑스 오픈',
    ...
    {
      question:
        '야구에서 MLB 역사상 한 시즌 최다 타점을 기록한 선수는 누구인가요?',
    ...
    {
      question:
        '올림픽 체조에서 여자 종목 중 4개의 기구를 모두 포함하는 경기는 무엇인가요?',
  ...
  literature: [
    ...
    {
      question:
        "'아기 돼지 삼형제'에서 셋째 돼지가 집을 지은 재료는 무엇인가요?",
      options: ['짚', '나무', '벽돌', '흙'],
      answer: '벽돌',
      difficulty: 'easy',
    },
    ...
    {
      question:
        "'이솝 우화'에서 토끼와 거북이 경주에서 이긴 동물은 누구인가요?",
    ...
    {
      question:
        "'백조 왕자'에서 엘리사가 오빠들을 구하기 위해 한 일은 무엇인가요?",
      options: [
        '마녀와 계약했다',
        '마법의 성을 찾았다',
        '쐐기풀로 옷을 짰다',
    ...
    {
      question:
        "'로미오와 줄리엣'에서 로미오와 줄리엣의 죽음을 초래한 주요 원인은 무엇인가요?",
    ...
    {
      question:
        "'광장'에서 이명준이 남한과 북한을 모두 거부한 이유는 무엇인가요?",
    ...
    {
      question:
        "김소월의 시 '진달래꽃'에서 화자가 떠나는 연인에게 바라는 것은 무엇인가요?",
      options: ['복수', '재회', '행복', '고통'],
      answer: '행복',
      difficulty: 'medium',
    },
    {
      question:
        "김춘수의 시 '꽃'에서 '이름을 불러줌'이 상징하는 것은 무엇인가요?",
    ...
    {
      question:
        "이상의 소설 '날개'에서 주인공이 마지막에 바라는 것은 무엇인가요?",
    ...
    {
      question:
        "윤동주의 시 '서시'에서 화자가 부끄럼 없이 살기 위해 우러러보는 것은 무엇인가요?",
      options: ['별', '하늘', '산', '바다'],
      answer: '하늘',
      difficulty: 'medium',
    },
    ...
    {
      question:
        "한용운의 '님의 침묵'에서 '님'이 돌아올 것이라는 화자의 믿음은 무엇을 나타내나요?",
    ...
    {
      question:
        "김수영의 시 '풀'에서 '풀'이 짓밟혀도 일어나는 모습은 무엇을 나타내나요?",
    ...
    {
      question:
        "셰익스피어의 '십이야'에서 비올라가 남장을 한 이유는 무엇인가요?",
    ...
    {
      question:
        "'변신'에서 그레고르가 벌레로 변한 후 가족의 궁극적 행동은 무엇인가요?",
      options: [
        '그를 돌본다',
        '그를 버린다',
        '그를 치료하려 한다',
    ...
    {
      question:
        "'폭풍의 언덕'에서 히스클리프와 캐서린의 사랑은 어떤 특징을 가지나요?",
      options: [
        '평온하고 안정적',
        '파괴적이고 격정적',
        '이성적이고 계산적',
    ...
    {
      question:
        "'프랑켄슈타인'에서 빅터 프랑켄슈타인이 괴물을 만든 동기는 무엇인가요?",
    ...
    {
      question:
        "'시간의 주름'에서 메그와 찰스가 우주를 여행한 이유는 무엇인가요?",
    ...
    {
      question:
        "'젊은 베르테르의 슬픔'에서 베르테르의 비극적 결말은 무엇인가요?",
      options: ['결혼', '자살', '추방', '재회'],
      answer: '자살',
      difficulty: 'medium',
    },
    ...
    {
      question:
        "이육사의 시 '절정'에서 '백두산' 상징이 반영하는 한국 문학사적 맥락은 무엇인가요?",
      options: [
        '낭만주의적 자연 숭배',
        '일제강점기 저항시의 민족의식',
        '현대주의적 개인 내면',
    ...
    {
      question:
        "김승옥의 '무진기행'에서 '무진'의 허무적 공간이 1960년대 한국 문학의 어떤 철학적 담론과 연결되나요?",
      options: [
        '실존주의와 소외',
        '맑스주의적 계층투쟁',
        '종교적 구원론',
    ...
    {
      question:
        "박인환의 시 '세월이 가면'이 전후 모더니즘 시로서 한국 문학사에서 가지는 의의는 무엇인가요?",
      options: [
        '전통 서정시의 계승',
        '도시적 감수성과 허무의 형상화',
        '민중 중심의 사회비판',
    ...
    {
      question:
        "조세희의 '난쟁이가 쏘아올린 작은 공'에서 '작은 공'의 무력한 저항이 1970년대 한국 사회의 어떤 구조적 문제를 비판하나요?",
      options: [
        '일제 잔재',
        '군사정권의 억압',
        '산업화와 계층 양극화',
    ...
    {
      question:
        "황순원의 '학'에서 '학'의 회복 불가능한 순수가 반영하는 문학사적 배경은 무엇인가요?",
      options: [
        '전통적 서정의 재발견',
        '일제강점기 상실감',
        '전후 한국의 정체성 위기',
    ...
    {
      question:
        "윤동주의 '사슴'에서 순수한 자아로서의 '사슴'이 일제강점기 문학에서 어떤 철학적 저항을 나타내나요?",
      options: [
        '계몽주의적 이성',
        '민족적 정체성의 보존',
        '종교적 초월',
    ...
    {
      question:
        "조정래의 '태백산맥'에서 염상진과 하대치의 이념 갈등이 한국 현대사의 어떤 역사적 사건을 재구성하나요?",
      options: [
        '4.19 혁명',
        '여순사건과 한국전쟁',
        '광주민주화운동',
    ...
    {
      question:
        "황순원의 '소나기'에서 순행적 시간 구조가 작품의 서정성을 강화하는 방식은 무엇인가요?",
      options: [
        '철학적 성찰의 복잡성',
        '순수한 감정의 직선적 전개',
        '다층적 상징의 중첩',
    ...
    {
      question:
        "김기림의 '바다와 나비'에서 나비의 미완의 이상 추구가 한국 모더니즘 시의 어떤 한계를 드러내나요?",
      options: [
        '전통과의 단절',
        '근대적 자아의 좌절',
        '사회적 책임의 결여',
    ...
    {
      question:
        "최인훈의 '광장'에서 '광장'과 '밀실'의 상징이 한국 현대사의 어떤 철학적 담론을 반영하나요?",
      options: [
        '공공성과 개인성의 대립',
        '종교적 구원과 세속적 욕망',
        '자연과 문명의 갈등',
    ...
    {
      question:
        "이상화의 '오발탄'에서 '탄환'의 방향성 상실이 전후 한국 문학의 어떤 사상적 흐름을 나타내나요?",
      options: [
        '낭만주의적 이상',
        '실존주의적 허무',
        '사회주의적 투쟁',
    ...
    {
      question:
        "김소월의 '초혼'에서 '오오, 오오'의 주문적 반복이 한국 전통 문학의 어떤 요소를 계승하나요?",
      options: [
        '한문 산문의 격식',
        '샤머니즘적 의례 언어',
        '불교적 명상',
    ...
    {
      question:
        '박완서의 소설에서 도시 여성의 일상 묘사가 1970~80년대 한국 문학사에서 어떤 비판적 역할을 했나요?',
      options: [
        '전통 가부장제의 복원',
        '산업화와 여성 억압의 고발',
        '민족주의적 통합',
    ...
    {
      question:
        "김유정의 '동백꽃'에서 사투리적 구어체가 한국 근대 문학에서 어떤 미학적 혁신을 이루었나요?",
      options: [
        '추상적 언어의 도입',
        '민중 언어의 문학적 승화',
        '고전 한문체의 부활',
    ...
    {
      question:
        "'메밀꽃 필 무렵'의 서정적 묘사가 한국 근대 문학에서 어떤 문학사적 전환을 나타내나요?",
      options: [
        '사회주의 리얼리즘의 시작',
        '서정성과 자연미의 재발견',
        '도시 모더니즘의 확산',
    ...
    {
      question:
        "셰익스피어의 '햄릿'에서 '죽느냐 사느냐' 독백이 르네상스 시대의 어떤 철학적 사조를 반영하나요?",
      options: [
        '스토아주의',
        '인문주의적 회의론',
        '중세 신학',
    ...
    {
      question:
        "도스토옙스키의 '죄와 벌'에서 라스콜니코프의 초월자 사상이 니체 철학과 어떻게 교차하나요?",
      options: [
        '허무주의적 절망',
        '초인 개념의 선구적 탐구',
        '종교적 구원의 대안',
    ...
    {
      question:
        "'위대한 개츠비'에서 녹색 불빛의 상징이 미국 문학사에서 어떤 비판적 담론을 드러내나요?",
      options: [
        '자본주의적 물신숭배',
        '아메리칸 드림의 허구성',
        '종교적 이상의 몰락',
    ...
    {
      question:
        "도스토옙스키의 '카라마조프가의 형제들'에서 '대심문관' 에피소드가 비판하는 서구 문학사적 사조는 무엇인가요?",
      options: [
        '낭만주의적 이상주의',
        '계몽주의적 이성주의',
        '종교적 권위주의',
    ...
    {
      question:
        "카프카의 '변신'에서 한정된 3인칭 시점이 현대 문학의 어떤 철학적 경향을 강화하나요?",
      options: [
        '실존주의적 소외',
        '구조주의적 기호',
        '포스트모더니즘의 해체',
    ...
    {
      question:
        "제임스 조이스의 '율리시스'에서 의식의 흐름 기법이 20세기 문학사에서 어떤 혁신을 이루었나요?",
      options: [
        '전통 서사의 복원',
        '내면 심리의 사실적 탐구',
        '사회적 리얼리즘의 강화',
    ...
    {
      question:
        "카뮈의 '이방인'에서 뫼르소의 감정 부재가 실존주의 철학의 어떤 개념을 구현하나요?",
      options: [
        '허무와 부조리',
        '초월적 구원',
        '계급적 저항',
    ...
    {
      question:
        "샐린저의 '호밀밭의 파수꾼'에서 홀든의 순수 추구가 미국 문학사에서 어떤 사회적 비판과 연결되나요?",
      options: [
        '자본주의적 타락',
        '종교적 위선',
        '전통 가족의 붕괴',
    ...
    {
      question:
        "에밀리 브론테의 '폭풍의 언덕'에서 히스클리프의 고딕적 반영웅 이미지가 낭만주의 문학의 어떤 특징을 극대화하나요?",
      options: [
        '이성적 조화',
        '감정의 극단과 초월',
        '사회적 규범의 준수',
    ...
    {
      question:
        "멜빌의 '모비 딕'에서 고래의 절대적 진리 상징이 미국 문학사에서 어떤 철학적 전통과 연결되나요?",
    ...
    {
      question:
        "메리 셀리의 '프랑켄슈타인'에서 괴물의 소외가 낭만주의 문학의 어떤 비판적 주제를 부각시키나요?",
      options: [
        '과학의 오만과 윤리적 책임',
        '종교적 구원의 필요성',
        '사회 계층의 고정성',
    ...
    {
      question:
        "톨스토이의 '안나 카레니나'에서 열차의 비극적 상징이 러시아 문학사에서 어떤 사회적 변화를 반영하나요?",
      options: [
        '농업 사회의 몰락',
        '산업화와 도덕적 위기',
        '제국주의적 팽창',
    ...
    {
      question:
        "호손의 '주홍글자'에서 'A'의 의미 변화가 미국 문학사에서 어떤 윤리적 담론을 드러내나요?",
      options: [
        '청교도 윤리의 재구성',
        '계몽주의적 개인주의',
        '낭만주의적 초월',
    ...
    {
      question:
        "세르반테스의 '돈키호테'에서 중세 기사문학 추구가 스페인 문학사에서 어떤 전환을 풍자하나요?",
      options: [
        '르네상스 인문주의의 등장',
        '종교개혁의 확산',
        '봉건제의 존속',
    ...
    {
      question:
        "헤세의 '데미안'에서 '새는 알을 깨고 나온다'의 상징이 20세기 문학사에서 어떤 철학적 사조와 연결되나요?",
      options: [
        '실존주의적 자아 발견',
        '구조주의적 해체',
        '마르크스주의적 계급투쟁',
  ...
  art: [
    ...
    {
      question:
        '미켈란젤로의 시스티나 성당 천장화가 묘사하는 주요 주제는 무엇인가요?',
    ...
    {
      question:
        "빈센트 반 고흐의 '해바라기'가 표현하는 주요 감정은 무엇인가요?",
    ...
    {
      question:
        '칸딘스키의 색채 감정 이론이 주로 적용된 예술 사조는 무엇인가요?',
    ...
    {
      question:
        "나움 가보의 '검은 광선 이론'이 현대 예술사에서 강조한 철학적 전환은 무엇인가요?",
      options: [
        '종교적 상징의 복원',
        '과학과 예술의 융합',
        '낭만주의적 감정',
    ...
    {
      question:
        "벨라스케스의 '라스 메니나스'가 근대 회화에 제시한 시각적 담론은 무엇인가요?",
      options: [
        '추상적 형태의 도입',
        '시점과 주체의 해체',
        '종교적 권위의 재확인',
    ...
    {
      question:
        '미니멀 아트가 추상표현주의에 반대한 예술사적 맥락은 무엇인가요?',
      options: [
        '감정 중심의 격정 반대',
        '대중문화의 수용',
        '고전주의의 부활',
    ...
    {
      question:
        '에드바르 뭉크의 표현주의가 현대 예술사에서 심리학적 담론에 끼친 영향은 무엇인가요?',
      options: [
        '프로이트의 무의식 탐구 촉진',
        '계몽주의적 이성 복원',
        '사회주의적 계급투쟁',
    ...
    {
      question:
        '바그너의 총체예술(Gesamtkunstwerk)이 19세기 예술사에서 어떤 철학적 사조와 연결되나요?',
      options: [
        '실존주의',
        '낭만주의적 이상주의',
        '계몽주의 이성',
    ...
    {
      question:
        '마르셀 뒤샹의 레디메이드가 현대 예술사에서 촉발한 철학적 논쟁은 무엇인가요?',
      options: [
        '예술의 정의와 권위 해체',
        '산업화의 미학적 승화',
        '종교적 상징의 재발견',
    ...
    {
      question:
        '앙리 마티스의 색채 해방이 야수파 운동에서 어떤 미학적 혁신을 이루었나요?',
      options: [
        '구체적 재현의 복원',
        '감정 중심의 색채 표현',
        '기하학적 추상성',
    ...
    {
      question:
        '미국 행동주의 회화가 20세기 예술사에서 강조한 철학적 가치는 무엇인가요?',
      options: [
        '형식적 완결성',
        '즉흥성과 신체적 과정',
        '종교적 상징',
    ...
    {
      question:
        "피카소의 '게르니카'에서 단색 구성이 스페인 내전의 비극을 강화한 방식은 무엇인가요?",
      options: [
        '추상적 상징의 제거',
        '시각적 충격과 상징적 절제',
        '낭만적 색채의 도입',
    ...
    {
      question:
        "'화이트 큐브' 개념이 현대 미술관의 전시 방식에 끼친 예술사적 영향은 무엇인가요?",
      options: [
        '작품의 맥락적 중립성 강화',
        '종교적 상징의 부활',
        '대중문화의 통합',
    ...
    {
      question:
        '칸딘스키의 추상화가 음악적 개념과 결합하여 현대 예술사에 제시한 철학적 전환은 무엇인가요?',
      options: [
        '형식주의적 구조',
        '감정과 직관의 시각적 구현',
        '사회적 계급 비판',
    ...
    {
      question:
        '디터 람스의 디자인 철학이 현대 산업디자인에 끼친 예술사적 영향은 무엇인가요?',
      options: [
        '장식적 화려함의 부흥',
        '기능성과 단순함의 미학적 통합',
        '종교적 상징의 재발견',
    ...
    {
      question:
        '고딕 건축의 첨탑과 스테인드글라스가 중세 예술사에서 반영한 철학적 이상은 무엇인가요?',
      options: [
        '세속적 권력의 강조',
        '신의 빛과 초월적 지향',
        '인간 중심적 이성',
    ...
    {
      question:
        '조토의 회화가 르네상스 예술사로의 전환에서 어떤 미학적 혁신을 이루었나요?',
      options: [
        '추상적 상징의 강화',
        '인체와 공간의 사실적 재현',
        '종교적 도상의 단순화',
    ...
    {
      question:
        "프랭크 로이드 라이트의 '낙수장'이 현대 건축사에서 상징하는 철학적 가치는 무엇인가요?",
      options: [
        '도시 중심주의',
        '자연과 인간의 유기적 통합',
        '종교적 상징의 재발견',
    ...
    {
      question:
        '마크 로스코의 색면 회화가 현대 예술사에서 추구한 미학적 경험은 무엇인가요?',
      options: [
        '지적 분석의 촉진',
        '명상적 몰입과 정서적 공명',
        '사회적 풍자의 강화',
    ...
    {
      question:
        '해체주의 건축이 현대 예술사에서 반영한 철학적 사조는 무엇인가요?',
      options: [
        '구조주의적 질서',
        '포스트모더니즘의 해체적 사유',
        '낭만주의적 이상',
    ...
    {
      question:
        '동세 표현 기법이 르네상스 예술사에서 시간성을 강조한 방식은 무엇인가요?',
      options: [
        '정적 구도의 강화',
        '움직임의 순간적 포착',
        '추상적 색채의 도입',
    ...
    {
      question:
        '윌리엄 모리스의 아트 앤 크래프트 운동이 현대 예술사에 끼친 철학적 영향은 무엇인가요?',
      options: [
        '산업화의 전면적 수용',
        '수공예와 노동의 미학적 복원',
        '종교적 상징의 강화',
    ...
    {
      question:
        '하이 레졸루션 이미지가 현대 예술사에서 촉발한 철학적 논쟁은 무엇인가요?',
      options: [
        '예술의 원본성과 복제의 경계',
        '종교적 상징의 부활',
        '형식적 완결성의 재발견',
    ...
    {
      question:
        '바우하우스의 예술과 기술 통합이 현대 디자인사에 끼친 철학적 영향은 무엇인가요?',
      options: [
        '장식적 화려함의 부흥',
        '기능적 디자인의 민주화',
        '종교적 상징의 재발견',
    ...
    {
      question:
        '조르조 바사리의 미술사 저술이 르네상스 예술사에서 어떤 학문적 기여를 했나요?',
      options: [
        '추상주의의 이론화',
        '미술사학의 체계적 기초 확립',
        '종교적 상징의 재발견',
    ...
    {
      question:
        '인상주의와 후기 인상주의의 예술사적 차이가 현대 회화에 끼친 영향은 무엇인가요?',
      options: [
        '종교적 상징의 부활',
        '구조적 분석과 개성의 강조',
        '평면적 구도의 복원',
    ...
    {
      question:
        '데칼코마니 기법이 초현실주의 예술사에서 어떤 철학적 탐구를 촉진했나요?',
      options: [
        '형식적 완결성',
        '무의식과 우연의 창작',
        '종교적 상징의 재발견',
    ...
    {
      question:
        "피에르 부르디외의 '문화 자본' 개념이 현대 예술사에서 비판한 사회적 구조는 무엇인가요?",
      options: [
        '예술의 민주화',
        '계층적 취향과 권력 구조',
        '종교적 상징의 부활',
    ...
    {
      question:
        '일본 우키요에가 인상주의 예술사에 끼친 미학적 영향은 무엇인가요?',
      options: [
        '추상적 형태의 도입',
        '평면적 구도와 색채의 대담성',
        '종교적 상징의 재발견',
    ...
    {
      question:
        '나보코프의 나비 수집이 현대 예술사에서 생태미학에 끼친 철학적 영향은 무엇인가요?',
      options: [
        '인간과 자연의 상호작용 탐구',
        '종교적 상징의 재발견',
        '추상적 형태의 도입',
    ...
    {
      question:
        '크리스 버든의 퍼포먼스 아트가 현대 예술사에서 강조한 철학적 가치는 무엇인가요?',
      options: [
        '형식적 완결성',
        '행위의 충격성과 한계 탐구',
        '종교적 상징의 재발견',
    ...
    {
      question:
        '동양화의 여백 미학이 현대 예술사에서 어떤 철학적 담론을 촉진했나요?',
      options: [
        '구체적 묘사의 강조',
        '무의 공간과 관람자의 상상력',
        '종교적 상징의 재발견',
    ...
    {
      question:
        "'해체적 시선'이 현대 예술사에서 비판한 철학적 구조는 무엇인가요?",
      options: [
        '종교적 상징의 재발견',
        '시각적 권력과 주체-대상 경계',
        '형식적 완결성',
  ...
  economy: [
    ...
    {
      question:
        '정부가 경제를 살리기 위해 세금을 줄이고 지출을 늘리는 정책은 무엇인가요?',
    ...
    {
      question:
        '몇몇 기업이 시장을 나눠 가격을 결정하는 시장 구조는 무엇인가요?',
    ...
    {
      question:
        '중앙은행이 기준금리 인하를 통해 경기 부양을 시도할 때 발생할 수 있는 장기적 위험은 무엇인가요?',
      options: [
        '실질 GDP 감소',
        '과도한 인플레이션 압력',
        '구조적 실업 증가',
    ...
    {
      question:
        '한계효용 체감의 법칙이 소비자 행동에 미치는 경제적 함의는 무엇인가요?',
      options: [
        '단일 상품에 대한 과소비 억제',
        '소비의 무한 증가',
        '가격 인상에 대한 수요 증가',
    ...
    {
      question:
        '수요의 가격 탄력성이 낮은 상품에 대한 가격 인상의 경제적 결과는 무엇인가요?',
      options: [
        '수익 감소와 소비자 잉여 축소',
        '수익 증가와 소비자 잉여 감소',
        '수요 증가와 시장 확대',
    ...
    {
      question:
        '정부의 재정지출 축소가 물가 안정에 기여하는 메커니즘은 무엇인가요?',
      options: [
        '통화량 증가 억제',
        '수요 증가 유도',
        '환율 상승 촉진',
    ...
    {
      question:
        '원화 가치 하락이 수입물가 상승을 초래하는 과정에서 발생하는 2차적 경제 효과는 무엇인가요?',
      options: [
        '무역흑자 확대',
        '국내 생산 비용 증가',
        '해외 투자 감소',
    ...
    {
      question:
        '디플레이션이 장기화될 경우 경제에 미치는 구조적 위험은 무엇인가요?',
      options: [
        '기업의 투자 확대',
        '부채의 실질 가치 증가',
        '소비자 구매력 상승',
    ...
    {
      question:
        '공급중심 정책이 경제성장을 지속 가능하게 만드는 주요 메커니즘은 무엇인가요?',
      options: [
        '단기 수요 증가',
        '생산 가능 경계의 외연 확장',
        '통화량의 즉각적 증가',
    ...
    {
      question:
        "화폐의 '가치 저장 수단' 기능이 약화될 경우 발생하는 경제적 문제는 무엇인가요?",
      options: [
        '거래 비용의 감소',
        '인플레이션 기대 심화',
        '소비자 신뢰 회복',
    ...
    {
      question:
        '정부 보조금이 특정 산업의 생산 증가를 초래할 때 발생할 수 있는 부정적 외부효과는 무엇인가요?',
      options: [
        '시장 왜곡과 비효율적 자원 배분',
        '소비자 잉여의 증가',
        '국제 경쟁력 강화',
    ...
    {
      question:
        '기준금리 인상이 경기과열 억제에 성공하지 못할 경우 발생할 수 있는 경제적 시나리오는 무엇인가요?',
      options: [
        '디플레이션의 장기화',
        '스태그플레이션의 출현',
        '무역흑자의 확대',
    ...
    {
      question:
        '경기 확장기의 과도한 경제 활동이 초래할 수 있는 장기적 경제적 위험은 무엇인가요?',
      options: [
        '자산 버블 형성과 금융 불안정',
        '실업률의 구조적 감소',
        '통화량의 지속적 감소',
    ...
    {
      question:
        '외환보유액 증가를 위한 달러 매입이 국내 경제에 미치는 부작용은 무엇인가요?',
      options: [
        '원화 가치의 과도한 상승',
        '국내 통화량 증가와 인플레이션 압력',
        '무역적자의 즉각적 감소',
    ...
    {
      question:
        '기업이 생산과 소비를 동시에 수행하는 경제적 역할이 초래하는 시장 내 갈등은 무엇인가요?',
      options: [
        '가격 결정의 독점화 경향',
        '소비자 잉여의 증가',
        '환경 지속 가능성 증진',
    ...
    {
      question:
        '인플레이션이 저실업률 환경에서 발생하는 경제적 원인은 무엇인가요?',
      options: [
        '공급 충격의 지속',
        '수요-견인 인플레이션',
        '통화량의 구조적 감소',
    ...
    {
      question:
        '경상수지가 지속적인 적자를 기록할 경우 발생할 수 있는 경제적 문제는 무엇인가요?',
      options: [
        '외환위기와 통화 가치 하락',
        '소비자 신뢰의 즉각적 회복',
        '무역흑자의 구조적 증가',
    ...
    {
      question:
        '자유시장경제가 초래할 수 있는 경제적 불균형의 주요 원인은 무엇인가요?',
      options: [
        '정부의 과도한 개입',
        '시장 실패와 외부효과의 무시',
        '통화량의 지속적 감소',
    ...
    {
      question:
        '디플레이션이 실질 GDP 감소로 이어지는 거시경제적 경로는 무엇인가요?',
      options: [
        '소비 지출의 증가',
        '기업 투자와 소비의 동반 위축',
        '무역흑자의 구조적 확대',
    ...
    {
      question:
        '자국 상품의 경쟁력 강화가 수출 증가로 이어지지 않을 경우의 주요 원인은 무엇인가요?',
      options: [
        '글로벌 수요의 구조적 감소',
        '소비자 신뢰의 즉각적 회복',
        '통화량의 지속적 증가',
    ...
    {
      question:
        '과도한 통화량 증가가 인플레이션 외에 초래할 수 있는 경제적 부작용은 무엇인가요?',
      options: [
        '자산 가격의 비이성적 상승',
        '소비자 신뢰의 즉각적 회복',
        '무역수지의 안정화',
    ...
    {
      question:
        '실업률 계산에서 경제활동인구를 분모로 사용하는 이유는 무엇인가요?',
      options: [
        '노동 시장의 실제 참여도를 반영하기 위해',
        '소비자 신뢰를 측정하기 위해',
        '통화량의 변동성을 반영하기 위해',
        '무역수지의 변화를 예측하기 위해',
      ],
    ...
    {
      question:
        '긴축 정책이 경기 과열 방지에 실패할 경우 발생할 수 있는 경제적 결과는 무엇인가요?',
      options: [
        '무역흑자의 구조적 확대',
        '크라우딩 아웃과 재정 적자 심화',
        '소비자 신뢰의 즉각적 회복',
    ...
    {
      question:
        '자동화 도입이 생산성 향상 외에 노동 시장에 미치는 장기적 부작용은 무엇인가요?',
      options: [
        '구조적 실업의 증가',
        '소비자 신뢰의 즉각적 회복',
        '무역수지의 안정화',
    ...
    {
      question:
        '소비자들의 인플레이션 기대가 소비 증가로 이어지는 거시경제적 메커니즘은 무엇인가요?',
      options: [
        '구매력의 즉각적 감소',
        '실질 소득의 감소',
        '미래 가격 상승에 대한 선제적 대응',
    ...
    {
      question:
        '유동성 함정이 지속되는 거시경제적 환경에서 효과적인 정책 대안은 무엇인가요?',
      options: [
        '기준금리 추가 인하',
        '재정지출 확대와 구조 개혁',
        '통화량의 지속적 감소',
  ...
  proverb: [
    ...
    {
      question:
        "'하늘이 무너져도 솟아날 구멍은 있다'가 주는 희망적인 메시지는 무엇인가요?",
      options: [
        '어려움에도 해결책이 있다',
        '하늘은 항상 안전하다',
        '포기하는 것이 최선이다',
    ...
    {
      question:
        "'윗물이 맑아야 아랫물이 맑다'가 강조하는 리더십의 요소는 무엇인가요?",
    ...
    {
      question:
        "'콩 심은 데 콩 나고 팥 심은 데 팥 난다'가 나타내는 원리는 무엇인가요?",
      options: [
        '행동에 따른 결과의 필연성',
        '농사의 다양성',
        '작물의 우연한 성장',
    ...
    {
      question:
        "'낫 놓고 기역자도 모른다'가 비유하는 사람의 상태는 무엇인가요?",
      options: [
        '기초 지식이 부족한 상태',
        '공부를 열심히 한 상태',
        '도구를 잘 다루는 상태',
    ...
    {
      question:
        "'사공이 많으면 배가 산으로 간다'가 경계하는 상황은 무엇인가요?",
      options: [
        '협동의 중요성',
        '의견 충돌로 인한 혼란',
        '사공의 능력 부족',
    ...
    {
      question:
        "'각주구검(刻舟求劍)'의 역사적 유래와 현대적 적용은 무엇인가요?",
      options: [
        '춘추전국시대의 어리석은 행동, 변화에 적응하지 못하는 태도',
        '한나라의 전쟁 전략, 신중한 계획의 중요성',
        '조선시대의 학문적 태도, 고전 학습의 필요성',
        '고구려의 외교 정책, 협상의 기술',
      ],
    ...
    {
      question:
        "'마부위침(磨斧爲針)'이 철학적으로 강조하는 삶의 태도는 무엇인가요?",
      options: [
        '즉흥적인 행동의 가치',
        '꾸준한 노력과 인내의 중요성',
        '도구의 효율적 사용',
    ...
    {
      question:
        "'조삼모사(朝三暮四)'의 유래와 현대 정치에서의 적용 가능성은 무엇인가요?",
      options: [
        '춘추전국시대의 말장난, 정책 발표의 표현 조작',
        '한나라의 경제 정책, 세금 조정의 기술',
        '고려시대의 교육법, 학습 순서의 조정',
        '신라의 군사 전략, 병력 배치의 변화',
      ],
    ...
    {
      question:
        "'연목구어(緣木求魚)'가 비판하는 행동의 현대적 예시는 무엇인가요?",
      options: [
        '잘못된 투자 전략으로 자산 증대를 기대하는 행위',
        '효율적인 팀워크로 프로젝트를 완성하는 행위',
        '과학적 연구로 새로운 발견을 추구하는 행위',
        '교육 개혁으로 학습 성과를 높이는 행위',
      ],
    ...
    {
      question:
        "'지록위마(指鹿爲馬)'의 역사적 배경과 현대 사회에서의 유사 사례는 무엇인가요?",
      options: [
        '진나라의 권력 남용, 가짜 뉴스의 유포',
        '당나라의 외교 정책, 동맹국의 설득',
        '고구려의 전쟁 전략, 적의 혼란 유도',
        '조선의 법제도, 공정한 판결',
      ],
    ...
    {
      question:
        "'토사구팽(兎死狗烹)'이 경계하는 윤리적 문제와 현대적 맥락은 무엇인가요?",
      options: [
        '인재 활용 후 배신, 기업의 인력 구조조정',
        '동물 보호의 필요성, 환경 정책의 강화',
        '전쟁 후 재건, 국가의 복구 노력',
        '교육의 공정성, 학생 선발의 투명성',
      ],
    ...
    {
      question:
        "'형설지공(螢雪之功)'의 철학적 함의와 현대 교육에서의 적용은 무엇인가요?",
      options: [
        '어려운 환경에서의 노력, 자기주도 학습의 중요성',
        '자연과의 조화, 환경 교육의 필요성',
        '공정한 경쟁, 시험 제도의 개혁',
        '단체 학습, 팀워크의 강화',
      ],
    ...
    {
      question:
        "'우공이산(愚公移山)'의 유래와 현대적 리더십에 주는 교훈은 무엇인가요?",
      options: [
        '중국 고대의 끈기, 장기적 비전의 중요성',
        '한나라의 건설 기술, 인프라 개발의 필요성',
        '조선의 농업 개혁, 토지 관리의 효율성',
        '고려의 군사 전략, 방어 체계의 강화',
      ],
    ...
    {
      question:
        "'망양지탄(望洋之歎)'의 철학적 배경과 현대적 응용은 무엇인가요?",
      options: [
        '자신의 한계 인식, 겸손한 태도의 필요성',
        '바다의 중요성, 해양 자원 개발',
        '지도자의 책임, 국가 정책의 조정',
        '여행의 가치, 새로운 경험의 추구',
      ],
    ...
    {
      question:
        "'계란유골(鷄卵有骨)'이 비유하는 현대적 상황과 그 교훈은 무엇인가요?",
      options: [
        '운의 불확실성, 위험 관리의 중요성',
        '달걀의 강도, 품질 관리의 필요성',
        '닭의 번식, 농업 기술의 발전',
    ...
    {
      question:
        "'고장난명(孤掌難鳴)'의 철학적 함의와 조직에서의 적용은 무엇인가요?",
      options: [
        '협력의 필요성, 팀워크의 중요성',
        '개인의 독립성, 자율적 의사결정',
        '소리의 중요성, 커뮤니케이션 기술',
    ...
    {
      question:
        "'교각살우(矯角殺牛)'의 역사적 맥락과 현대 경영에서의 교훈은 무엇인가요?",
      options: [
        '고대의 기술적 오류, 세부 조정의 위험성',
        '조선의 농업 기술, 소 관리의 중요성',
        '한나라의 군사 전략, 병력 배치의 효율성',
        '고구려의 건축 기술, 구조적 안정성',
      ],
    ...
    {
      question:
        "'군계일학(群鷄一鶴)'이 현대 사회에서 상징하는 인재상은 무엇인가요?",
      options: [
        '탁월한 리더십과 독창성',
        '평균적인 능력과 협력',
        '전통적 지식의 계승',
    ...
    {
      question:
        "'금의환향(錦衣還鄕)'의 역사적 배경과 현대적 가치관에서의 재해석은 무엇인가요?",
      options: [
        '고대의 출세, 지역 사회로의 기여',
        '조선의 관료 제도, 공직자의 책임',
        '한나라의 전쟁, 군인의 명예',
    ...
    {
      question:
        "'난형난제(難兄難弟)'의 철학적 맥락과 현대 경쟁 환경에서의 적용은 무엇인가요?",
      options: [
        '우열의 불분명성, 공정한 경쟁의 필요성',
        '형제의 우애, 가족 중심의 가치',
        '지도자의 책임, 리더십의 균형',
        '교육의 공정성, 평가 기준의 명확성',
      ],
    ...
    {
      question:
        "'동병상련(同病相憐)'의 심리적 배경과 현대 사회에서의 응용은 무엇인가요?",
      options: [
        '공감의 심리, 커뮤니티 지원의 중요성',
        '질병의 치료, 의료 기술의 발전',
        '경쟁의 심리, 승리 전략의 필요성',
    ...
    {
      question:
        "'독불장군(獨不將軍)'의 철학적 함의와 현대 조직에서의 교훈은 무엇인가요?",
      options: [
        '협력의 필수성, 조직 내 소통의 중요성',
        '독립적 리더십, 단독 결정의 가치',
        '군사적 전략, 단일 지휘 체계',
        '개인의 명예, 독립적 업적의 중요성',
      ],
    ...
    {
      question:
        "'미생지신(尾生之信)'의 역사적 유래와 현대적 윤리적 딜레마는 무엇인가요?",
      options: [
        '고대 중국의 신의, 과도한 약속의 위험성',
        '조선의 도덕률, 사회적 신뢰의 중요성',
        '한나라의 법제도, 계약의 엄격성',
        '고구려의 외교, 동맹의 신뢰',
      ],
    ...
    {
      question:
        "'박학다식(博學多識)'의 철학적 가치와 현대 교육에서의 적용은 무엇인가요?",
      options: [
        '광범위한 지식 추구, 융합적 사고의 중요성',
        '전문성의 집중, 단일 분야의 깊이',
        '학문의 전통, 고전 학습의 필요성',
        '시험의 공정성, 평가의 다양성',
      ],
    ...
    {
      question:
        "'배수진(背水陣)'의 역사적 맥락과 현대적 전략에서의 응용은 무엇인가요?",
      options: [
        '한나라의 전쟁 전략, 결단력 있는 리스크 테이킹',
        '조선의 방어 전략, 성곽 건설의 중요성',
        '고구려의 외교, 동맹의 강화',
        '고려의 경제 정책, 자원 배분의 효율성',
      ],
    ...
    {
      question:
        "'설상가상(雪上加霜)'의 철학적 함의와 현대 위기 관리에서의 교훈은 무엇인가요?",
      options: [
        '악재의 연속성, 복합 위기 대비의 필요성',
        '겨울의 아름다움, 환경 보호의 중요성',
        '눈의 상징성, 문화적 전통의 계승',
        '서리의 위험성, 기후 변화 대응',
      ],
    ...
    {
      question:
        "'승승장구(乘勝長驅)'의 역사적 배경과 현대 비즈니스에서의 적용은 무엇인가요?",
      options: [
        '고대의 전쟁 승리, 시장 선점 전략의 중요성',
        '조선의 외교 정책, 국제 협력의 필요성',
        '한나라의 경제 성장, 자원 관리의 효율성',
        '고구려의 문화 발전, 예술의 진흥',
      ],
    ...
    {
      question:
        "'오리무중(五里霧中)'의 철학적 맥락과 현대 의사결정에서의 교훈은 무엇인가요?",
      options: [
        '불확실성의 인식, 정보 기반 의사결정의 필요성',
        '안개의 아름다움, 자연과의 조화',
        '길의 중요성, 인프라 개발의 필요성',
        '여행의 가치, 새로운 경험의 추구',
      ],
    ...
    {
      question:
        "'유비무환(有備無患)'의 철학적 배경과 현대 리스크 관리에서의 적용은 무엇인가요?",
      options: [
        '선제적 대비의 중요성, 위기 관리 계획의 필요성',
        '즉흥적 행동의 가치, 유연한 대응',
        '걱정의 부재, 긍정적 사고의 중요성',
        '자원의 절약, 경제적 효율성',
      ],
    ...
    {
      question:
        "'작심삼일(作心三日)'의 심리적 배경과 현대 자기계발에서의 교훈은 무엇인가요?",
      options: [
        '결심의 일시성, 지속적 동기부여의 필요성',
        '결심의 중요성, 단기 목표의 가치',
        '시간의 경과, 빠른 성취의 필요성',
        '휴식의 가치, 재충전의 중요성',
      ],
    ...
    {
      question:
        "'전화위복(轉禍爲福)'의 철학적 함의와 현대 위기에서의 응용은 무엇인가요?",
      options: [
        '위기의 기회 전환, 혁신적 사고의 중요성',
        '불행의 영속성, 방어적 전략의 필요성',
        '복의 상징성, 문화적 전통의 계승',
        '재앙의 예측, 예방적 조치의 중요성',
      ],
    ...
    {
      question:
        "'청출어람(靑出於藍)'의 역사적 유래와 현대 교육에서의 교훈은 무엇인가요?",
      options: [
        '고대 중국의 염색, 후배의 혁신적 학습 필요성',
        '조선의 학문, 전통 계승의 중요성',
        '한나라의 기술, 공정 개선의 필요성',
        '고구려의 문화, 예술의 발전',
      ],
    ...
    {
      question:
        "'침소봉대(針小棒大)'의 철학적 비판과 현대 미디어에서의 적용은 무엇인가요?",
      options: [
        '과장의 위험성, 정보 왜곡의 문제',
        '작은 것의 가치, 소규모 혁신의 중요성',
        '봉의 상징성, 리더십의 상징',
        '침의 효율성, 정밀 작업의 필요성',
      ],
    ...
    {
      question:
        "'타산지석(他山之石)'의 철학적 가치와 현대 학습에서의 응용은 무엇인가요?",
      options: [
        '외부의 교훈 활용, 열린 학습 태도의 중요성',
        '돌의 중요성, 자원 관리의 필요성',
        '산의 상징성, 환경 보호의 가치',
        '경쟁의 중요성, 비교 우위의 추구',
      ],
    ...
    {
      question:
        "'호사다마(好事多魔)'의 철학적 배경과 현대 프로젝트 관리에서의 교훈은 무엇인가요?",
      options: [
        '성공의 장애 요인, 리스크 관리의 필요성',
        '좋은 일의 영속성, 낙관적 계획의 중요성',
        '마귀의 상징성, 문화적 전통의 계승',
        '복의 상징성, 긍정적 사고의 가치',
      ],
  ...
  history: [
    ...
    {
      question:
        '화엄종을 개창하고, 부석사를 건립하고, 관음 신앙을 강조한 인물은?',
      options: ['원광', '원효', '의상'],
      answer: '의상',
      difficulty: 'easy',
    },
    {
      question:
        '371년~384년 재위하였으며, 전진으로부터 불교를 수용하고, 태학을 설립하고, 백제의 수곡성을 공격한 왕은?',
    ...
    {
      question:
        '고려의 외교가이자 문신으로 거란 장수 소손녕과 외교 담판을 벌여 강동 6주를 확보한 인물은?',
      options: ['서희', '윤관', '최영'],
      answer: '서희',
      difficulty: 'easy',
    },
    {
      question:
        '고려 말 양광전라경상도 도순찰사로 황산에서 왜구를 무찌르고 위화도 회군으로 권력을 장악한 인물은?',
      options: ['이성계', '양규', '강감찬'],
      answer: '이성계',
      difficulty: 'easy',
    },
    {
      question:
        '다섯 개 이상의 돌을 가지고 던져 손으로 잡으며 노는 놀이로, 짜게받기, 살구, 닷짝걸이라고도 불리는 민속놀이는?',
    ...
    {
      question:
        '조선 시대 여인들을 위해 내의원, 혜민서에서 환자를 치료한 여자 의원은?',
      options: ['의녀', '무당', '백정'],
      answer: '의녀',
      difficulty: 'easy',
    },
    ...
    {
      question:
        "조만식의 주도로 평양에서 시작되어 '조선 사람 조선 것!', '내 살림 내 것으로!' 구호를 만든 민족 운동은?",
    ...
    {
      question:
        '대한 독립군 총사령관으로 봉오동 전투를 승리로 이끌고 카자흐스탄으로 강제 이주당한 인물은?',
      options: ['나석주', '지청천', '홍범도'],
      answer: '홍범도',
      difficulty: 'easy',
    },
    {
      question:
        '김원봉 등을 중심으로 창설되어 부대 일부가 한국 광복군에 합류한 조선 의용대에 대한 설명으로 옳은 것은?',
      options: [
        '중국 관내에서 결성된 최초의 한인 무장 조직이었다',
        '연통제와 교통국을 운영했다',
        '자유시 참변으로 큰 타격을 입었다',
      ],
    ...
    {
      question:
        '수도를 웅진에서 사비로 옮기고, 국호를 남부여로 바꾸고, 고구려에 빼앗겼던 한강 유역 일부를 수복한 왕은?',
      options: ['성왕', '무령왕', '근초고왕'],
      answer: '성왕',
      difficulty: 'easy',
    },
    {
      question:
        '고려의 국가 행사로, 왕이 태조의 제사를 지내고 신하들과 춤과 노래를 즐기며 주변 나라 상인과 사신이 특산물을 바친 행사는?',
      options: ['영고', '단오제', '팔관회'],
      answer: '팔관회',
      difficulty: 'easy',
    },
    {
      ...
      options: [
        '감자, 고구마 등의 작물이 널리 재배됐다',
        '활구라고 불리는 은병이 사용되었다',
        '시장을 감독하기 위한 동시전이 설치됐다',
      ],
    ...
    {
      question:
        '세조가 실시하라고 한 직전법에 대해 양성지가 반대한 이유와 관련된 설명은?',
      options: ['균역법', '영정법', '직전법'],
      answer: '직전법',
      difficulty: 'easy',
    },
    {
      question:
        '각 지역의 토산물을 정기적으로 수취하던 제도로, 대동법으로 문제점을 해결한 제도는?',
      options: ['공납', '군역', '환곡'],
      answer: '공납',
      difficulty: 'easy',
    },
    ...
    {
      question:
        '구식 군인이 정부의 개화 정책과 별기군 차별 대우에 반발하여 일으킨 사건은?',
    ...
    {
      question:
        '병자년에 일본과 체결하여 부산 외 원산과 인천을 추가 개항한 조약은?',
    ...
    {
      question:
        '고종의 장례 기간 중 탑골 공원에서 시작되어 대한민국 임시 정부 수립의 계기가 된 민족 운동은?',
      options: [
        '청군의 개입으로 진압됐다',
        '대한매일신보의 후원을 받았다',
        '대한민국 임시 정부 수립의 계기가 됐다',
      ],
    ...
    {
      question:
        '1920대 이상재 등이 중심이 되어 고등 교육 실현을 위해 전개한 민족 운동은?',
    ...
    {
      question:
        '전남도청 앞 금남로에서 계엄군의 집단 발포로 사상자가 발생한 민주화 운동은?',
    ...
    {
      question:
        '본기, 열전 등으로 구성된 기전체 형식으로 서술되고, 김부식 등이 왕명을 받아 편찬한 현존하는 가장 오래된 역사서는?',
    ...
    {
      question:
        '재해를 당하거나 생계가 어려운 백성들에게 곡식을 대여하거나 무상 지급한 고려와 조선 초기의 대표적인 구휼 기관은?',
      options: ['의창', '박문국', '제중원'],
      answer: '의창',
      difficulty: 'medium',
    },
    ...
    {
      question:
        '고려 승려로 불교계 타락을 비판하며 정혜쌍수를 주장하고 불일보조국사 시호를 받은 인물의 업적은?',
      options: [
        '천태종을 창시했다',
        '수선사 결사를 제창했다',
    ...
    {
      question:
        '훈민정음 해례본이 유네스코 세계 기록 유산에 등재된 훈민정음을 창제한 왕의 업적은?',
      options: [
        '칠정산을 편찬했다',
        '악학궤범을 완성했다',
        '혼일강리역대국도지도를 제작했다',
    ...
    {
      question:
        '금난전권 폐지와 장용영 설치를 추진한 정조 재위 시기에 볼 수 있는 모습은?',
      options: [
        '수원 화성을 축조하는 백성',
        '원산 총파업에 참여하는 노동자',
        '만적과 봉기를 모의하는 노비',
    ...
    {
      question:
        '주동리 유적에서 빗살무늬 토기가 출토되고, 고구려비가 발견되며, 덕흥창이 설치되고 신립이 탄금대에서 싸운 지역은?',
      options: ['나주', '상주', '충주'],
      answer: '충주',
      difficulty: 'medium',
    },
    {
      question:
        '연행사로 청에 파견되어 조선책략을 들여오고 삼정이정청 설치를 건의한 박규수의 업적은?',
      options: [
        '추사체를 창안했다',
        '서전서숙을 설립했다',
        '삼정이정청 설치를 건의했다',
    ...
    {
      question:
        '전환국에서 발행한 보조 화폐로 화폐 정리 사업으로 발행이 중단된 화폐는?',
    ...
    {
      question:
        '황국 신민 서사 암송과 국민학교 명칭 사용 시기에 볼 수 있는 모습은?',
      options: [
        '한성순보를 발행하는 관리',
        '공출을 독려하는 애국반 반장',
        '육영 공원에서 영어를 배우는 학생',
    ...
    {
      question:
        '지방 자치제 실시, 조선 총독부 철거, OECD 가입 시기에 볼 수 있는 모습은?',
      options: [
        '베트남 전쟁에 파병되는 군인',
    ...
    {
      question:
        '북방 외교로 사회주의 국가들과 국교를 수립하고 남북한 유엔 동시 가입을 이룬 정부의 통일 노력은?',
      options: [
        '남북 기본 합의서를 교환했다',
        '미국과 브라운 각서에 합의했다',
        '6.15 남북 공동 선언을 채택했다',
    ...
    {
      question:
        '단궁, 과하마, 반어피가 특산물이고 무천 제천 행사와 책화 풍습이 있던 나라는?',
      options: ['동예', '마한', '부여'],
      answer: '동예',
      difficulty: 'medium',
    },
    {
      question:
        '원효의 아들로 이두를 체계화하고 신문왕에게 화왕계를 지어 바친 인물은?',
      options: ['강수', '설총', '의상'],
      answer: '설총',
      difficulty: 'medium',
    },
    ...
    {
      question:
        '백토를 분칠하고 음각으로 무늬를 표현한 고려 말부터 조선 전기까지 제작된 도자기는?',
      options: [
        '청자 상감 운학문 매병',
        '분청사기 음각어문 편병',
        '백자 달항아리',
    ...
    {
      question:
        '윤지충이 서학을 믿어 신주를 불태우고 처형된 시기에 볼 수 없는 모습은?',
      options: [
        '정감록을 읽는 양반',
        '판소리 공연을 하는 소리꾼',
        '삼별초의 일원으로 훈련하는 군인',
    ...
    {
      question:
        '제2차 수신사로 일본에 파견되어 조선책략을 들여오고 갑오개혁을 주도한 인물은?',
      options: ['김옥균', '김홍집', '서재필'],
      answer: '김홍집',
      difficulty: 'medium',
    },
    ...
    },
    {
      ...
      options: [
        '경인선 기차를 타고 가는 승객',
        '박문국에서 한성순보를 인쇄하는 기술자',
        '라디오 방송을 송출하는 경성 방송국 직원',
      ],
    ...
    {
      question:
        '조선 총독부가 토지 조사 사업을 위해 임시 토지 조사국원 양성소를 운영한 시기에 있었던 사실은?',
      options: [
        '회사령이 시행됐다',
        '관민 공동회가 열렸다',
        '국가 총동원법이 제정됐다',
    ...
    {
      question:
        '반민특위가 친일파 청산을 추진했으나 정부의 비협조로 어려움을 겪은 시기에 있었던 사실은?',
      options: [
        '농지 개혁법이 제정됐다',
        '최초로 100억 달러 수출을 달성했다',
        '경제 협력 개발 기구 가입이 이루어졌다',
      ],
      answer: '농지 개혁법이 제정됐다',
      difficulty: 'medium',
    },
    {
      question:
        '경부 고속도로 공사 중 77명 사망 사고가 발생한 정부 시기의 경제 상황은?',
      options: [
        '금융 실명제가 전면 실시됐다',
        '칠레와 자유 무역 협정이 체결됐다',
        '제 2차 경제 개발 5개년 계획이 시행됐다',
      ],
    ...
    {
      question:
        '국민학교 명칭이 초등학교로 바뀌고 조선 총독부 건물이 철거된 정부 시기에 있었던 사실은?',
      options: [
        '조선 총독부 건물이 철거됐다',
        '이라크에 자이툰 부대가 파병됐다',
        '한일 월드컵 축구 대회가 개최됐다',
    ...
    {
      question:
        '부여 송국리에서 출토된 비파형 동검과 민무늬 토기가 있는 시대의 생활 모습으로 옳은 것은?',
      options: [
        '소를 이용한 깊이갈이가 일반화됐다',
        '반달 돌칼을 사용해 벼를 수확했다',
    ...
    {
      question:
        '이진아시왕이 시조로 고령일대를 중심으로 세운 나라에 대한 설명으로 옳은 것은?',
      options: [
        '진흥왕 때 신라에 복속되었다',
        '집사부를 비롯한 14부를 설치했다',
    ...
    {
      question:
        '혜공왕 피살 후 왕위 쟁탈전이 치열했던 시기에 낭혜화상이 성주산문을 개창한 시기에 있었던 사실은?',
      options: [
        '김흠돌 등 진골 세력이 숙청됐다',
        '김헌창이 웅천주에서 반란을 일으켰다',
        '거칠부가 왕명에 의해 국사를 편찬했다',
      ],
    ...
    {
      question:
        '5경에서 절터, 불상, 석등 등이 발굴된 발해에 대한 설명으로 옳지 않은 것은?',
      options: [
        '교육 기관으로 주자감을 설립했다',
        '감찰 업무를 담당하는 중정대가 있었다',
        '내신좌평, 내두좌평 등 6좌평의 관제를 마련했다',
      ],
    ...
    },
    {
      ...
      options: [
        '한양을 남경으로 승격했다',
        '정계와 계백료서를 지어 관리의 규범을 제시했다',
        '쌍기의 건의를 받아들여 과거제를 실시했다',
      ],
    ...
    },
    {
      ...
      options: [
        '대각국사 의천이 천태종을 개창했다',
        '신돈을 중심으로 전민변정 사업이 추진됐다',
        '만적이 개경에서 노비를 모아 반란을 모의했다',
      ],
    ...
    {
      question:
        '이성계를 도와 조선 건국을 주도한 정도전에 대한 설명으로 옳은 것은?',
      options: [
        '불씨잡변을 지어 불교를 비판했다',
        '계유정난을 계기로 정계에서 축출됐다',
        '최초의 서원인 백운동 서원을 건립했다',
      ],
    ...
    },
    {
      ...
      options: [
        '수도 방어를 위해 금위영을 설치했다',
        '음악 이론 등을 집대성한 악학궤범을 완성했다',
        '한양을 기준으로 한 역법서인 칠정산을 간행했다',
      ],
    ...
    },
    {
      ...
      options: [
        '강화산성-정봉수가 후금의 침입에 맞서 싸웠다',
        '북한산성-김준룡이 근왕병을 이끌고 적장을 사살했다',
        '서울 한양도성-신립이 배수의 진을 치고 전투를 벌였다',
        '남한산성-병자호란 때 인조가 피란하여 항전했다',
      ],
    ...
    },
    {
      ...
      options: [
        '이괄의 난이 일어나 공주로 피란했다',
        '폐비 윤씨 사사 사건을 빌미로 신하들을 숙청했다',
        '위훈 삭제를 주장한 조광조 일파를 제거했다',
        '영창 대군을 죽이고 인목 대비를 유폐했다',
      ],
    ...
    },
    {
      ...
      options: [
        ...
        '오페르트가 남연군 묘 도굴을 시도했다',
        '국왕의 친위 부대인 장용영이 창설됐다',
        '박규수의 건의로 삼정이정청이 설치됐다',
      ],
    ...
    },
    {
      ...
      options: [
        '대한매일신보의 지원을 받아 확산됐다',
        '조선 총독부의 탄압과 방해로 실패했다',
        '백정에 대한 사회적 철폐를 요구했다',
        '조선 민립 대학 기성회에서 모금 활동을 주도했다',
      ],
    ...
    },
    {
      ...
      options: [
        '일제가 조작한 105인 사건으로 와해됐다',
        '파리 강화 회의에 독립 청원서를 제출했다',
        '단원인 윤봉길이 홍커우 공원 의거를 실행했다',
        '군사 훈련을 위해 조선 혁명 간부 학교를 설립했다',
      ],
    ...
    },
    {
      ...
      options: [
        '조선 노동 총동맹을 중심으로 전개됐다',
        '보국안민, 제폭구민 등이 구호로 사용됐다',
        '조선 관세령 폐지 등을 배경으로 확산했다',
        '일본 제일은행권 화폐가 유통되는 계기가 됐다',
      ],
    ...
    {
      question:
        '일본군이 남서 해안에 군사 방어 시설을 구축한 시기에 있었던 사실은?',
      options: [
        '고종의 밀지를 받아 독립 의군부가 결성됐다',
        '만주 군벌과 일제가 미쓰야 협정을 체결했다',
        '여자 정신 근로령으로 여성들이 강제 동원됐다',
        '독립운동의 방략을 논의하고자 국민 대표 회의가 개최됐다',
      ],
  ...
  commonSense: [
    ...
    {
      question:
        '탁월하고 독창성 있는 수학적 연구를 한 40세 미만의 수학자에게 수여되는 상으로 노벨 수학상이라고 불리는 상은 무엇인가?',
    ...
    {
      question:
        '초등학교나 유치원 정문에서 반경 300m 이내에 지정된 어린이 보호구역을 무엇이라 하는가?',
    ...
    {
      question:
        '환경을 이슈로 전폭적인 사회운동을 촉발시킨 20세기 환경학 최고의 고전은 무엇인가?',
      options: [
        '침묵의 봄',
        '렉서스와 올리브나무',
        '성장의 한계',
    ...
    {
      question:
        '석회암 등 퇴적암이 많은 지역에서 주로 발생하는 자연 현상으로, 땅이 가라앉아 생긴 구멍을 무엇이라 하는가?',
    ...
    {
      question:
        '아프리카에 위치한 사막으로 세계에서 가장 큰 규모를 갖고 있는 것은 다음 중 어느 사막인가?',
    ...
    {
      question:
        '중국에서는 관광객이라는 의미의 단어이고 한국에서는 중국 관광객을 의미하는 단어는 무엇인가?',
    ...
    {
      question:
        "'태양의 후예'라는 드라마에서 많이 사용한 광고로 영화나 드라마 등에서 특정 제품을 노출시켜 광고 효과를 노리는 것을 무엇이라 하는가?",
    ...
    {
      question:
        '우리나라의 계절에 영향을 주는 기단으로 고온 다습한 기단은 다음 중 무엇인가?',
      options: [
        '북태평양 기단',
        '오호츠크해 기단',
        '시베리아 기단',
    ...
    {
      question:
        '스마트 폰 등을 이용한 은행 업무, 지불 업무, 티켓 업무 등의 서비스를 하는 비즈니스 모델은?',
    ...
    {
      question:
        '도면을 바탕으로 3차원 물체를 만들어내는 기계를 무엇이라 하는가?',
    ...
    },
    {
      ...
      options: [
        ...
        '피의자는 변호인의 조언을 받을 권리가 있다.',
        '피의자는 다른 죄목으로 구속되지 않는다.',
      ],
    ...
    {
      question:
        '경제적으로 어렵고 사회적으로 소외되어 있는 사람들이 뜻을 같이하고 힘을 한데 모아 스스로 자신들의 처지를 개선하고 필요를 충족시키기 위해 만든 경제조직을 무엇이라 하는가?',
    ...
    {
      question:
        '다음 중 최초로 과거제도를 실시한 고려시대 왕은 누구인가? (2016, 한국연구재단)',
      options: ['태조', '태종', '광종', '성종'],
      answer: '광종',
      difficulty: 'medium',
    },
    ...
    {
      question:
        '국악기 중 가장 낮은 음역에 속하는 현악기로 7줄을 갖고 있는 악기는 무엇이라 하는가?',
    ...
    {
      question:
        '소셜 네트워크 서비스를 이용해 소규모 후원이나 투자 등의 목적으로 인터넷과 같은 플랫폼을 통해 다수의 개인들로부터 자금을 모으는 행위를 무엇이라 하는가?',
    ...
    {
      question:
        '컴퓨터 프로그램에 침입한 스팸과 컴퓨터 바이러스, 크래커를 탐지하는 가상 컴퓨터를 무엇이라 하는가?',
    ...
    {
      question:
        '생산연령인구 비중이 하락하면서 경제성장이 지체되는 것을 무엇이라 하는가?',
    ...
    {
      question:
        '캣츠(cats)는 앤드루 로이드 웨버가 작곡을 하고 1981년 영국에서 초연을 하면서 세계에서 가장 흥행에 성공한 뮤지컬 중 하나이다. 캣츠는 누구의 시를 바탕으로 곡을 붙였는가?',
    ...
    {
      question:
        '하나의 상품을 구입함으로써 그 상품과 연관된 제품을 연속적으로 구입하게 되는 현상을 무엇이라 하는가?',
    ...
    {
      question:
        '자신이 화가 나고 억압된 상태를 다른사람을 싫어하는 것으로 대신하는 정신병을 무엇이라 하는가?',
      options: ['편향', '투사', '반전', '해리'],
      answer: '투사',
      difficulty: 'medium',
    },
    ...
    {
      question:
        '보다 진보된 스마트 체계를 통해 언제 어디서나 다중 콘텐츠를 공유하고 실행할 수 있으며 끊김없는 이어보기가 가능한 사용자 중심적인 서비스이다. 하나의 콘텐츠를 스마트폰ㆍPCㆍ스마트TVㆍ태블릿PCㆍ자동차 등 다양한 디지털 정보기기에서 공유할 수 있는 차세대 컴퓨팅ㆍ네트워크 서비스를 무엇이라 하는가?',
      options: [
        '클라우드 서비스',
        'N스크린',
        '유비쿼터스 스크린',
    ...
    {
      question:
        '부동산 경기침체 장기화로 집값 하락이 지속되고 있는 가운데, 집을 팔더라도 대출금이나 세입자 전세금을 다 갚지 못하는 주택을 무엇이라 하는가?',
      options: [
        '세어(share) 주택',
        '깡통 주택',
        '푸어(poor) 주택',
    ...
    {
      question:
        '유능한 인재를 모아도 좋은 성과를 내지 못하는 현상을 무엇이라 하는가?',
      options: [
        '아테네 신드롬',
        '아폴로 신드롬',
        '올림푸스 신드롬',
    ...
    {
      question:
        '출퇴근 시간, 휴식 시간 등 짧은 시간에 간편하게 즐길 수 있는 문화 콘텐츠를 무엇이라 하는가?',
    ...
    },
    {
      ...
      options: [
        ...
        '루소 - 자연으로 돌아가라',
        '데카르트 - 인간은 수단이 아닌 목적이 되어야 한다.',
        '소크라테스 - 내가 아는 단 한가지 사실은 나는 아무것도 모른다는 것이다.',
      ],
    ...
    {
      question:
        '중장년층을 중심으로 노화를 최대한 늦추고 나이에 비해 젊게 살아가려는 욕구가 확산되는 사회적 현상을 무엇이라 하는가?',
      options: [
        '무드셀라 증후군',
        '샹그릴라 증후군',
        '드메 증후군',
    ...
    {
      question:
        '의회의 표결에서 가부동수(可否同數)일 때, 의장이 던지는 결정권 투표를 무엇이라 하는가?',
    ...
    {
      question:
        '다음 사자성어 중에서 숫자의 합은 얼마인가? 남가일몽, 장삼이사, 군계일학',
      options: ['4', '5', '9', '11'],
      answer: '9',
      difficulty: 'hard',
    },
    {
      question:
        '자신을 위한 소비에 적극적인 20~30대 여성을 칭하는 유형을 무엇이라 하는가?',
    ...
    {
      question:
        '문화유적이나 예술 등을 무분별하게 파괴하는 행위를 무엇이라 하는가?',
    ...
    {
      question:
        "화폐유통의 '폐단'을 지적한 학자와 '필요성'을 지적한 학자를 바르게 연결한 것은?",
      options: [
        '유형원 - 유수원',
        '정약용 - 이익',
        '박제가 - 홍대용',
    ...
    {
      question:
        '어떤 상황이 처음에는 미미하게 진행되다가 어느 순간 균형을 깨고 모든 것이 한순간에 변화되는 극적인 순간을 무엇이라 하는가?',
    ...
    {
      question:
        '근거가 없고 이치에 맞지 않는 것을 억지로 끌어대어 자기에게 유리하도록 맞춘다는 사자성어는 무엇인가?',
      options: [
        '권불십년(權不十年)',
        '견강부회(牽强附會)',
        '권토중래(捲土重來)',
    ...
    {
      question:
        '인상적이고 계속 화재가 되는 제품을 개발하여 초기 소비자를 장악하는 마케팅 기법을 무엇이라 하는가?',
      options: [
        '플래그십 마케팅',
        '버즈 마케팅',
        '엠부시 마케팅',
    ...
    {
      question:
        '적대적 인수·합병(M&A)의 시도가 있을 때 기존 주주들에게 시가보다 싼 가격에 지분을 매수할 수 있도록 권리를 부여하는 것을 무엇이라 하는가?',
    ...
    {
      question:
        '로마제국의 초대황제로 로마의 행정과 시설을 개혁하고 제국의 기틀을 닦은 인물은 누구인가?',
    ...
    {
      question:
        '엔캐리 트레이드로 높은 이익을 얻는 개인투자자들을 일컫는 말은 무엇인가?',
...
const difficultymeunBtn = document.getElementById('difficultymeunBtn');
...
document.querySelectorAll('.difficultyBtn').forEach((btn) => {
  btn.addEventListener('click', () => {
    ...
    } 퀴즈  (${getDifficultyText(currentDifficulty)})`;

    // 선택된 난이도 문제 필터링 후 10문제로 제한
    const filteredQuestions = quizData[currentCategory].filter(
    ...
    progressEl.innerText = `진행도 0/${currentQuizData.length}`; // 시작 진행도를 표시합니다
  ...
  if (currentQuiz < currentQuizData.length) {
    ...
    shuffledOptions.forEach((option) => {
      ...
      btn.addEventListener('click', (e) =>
        selectAnswer(option, e.currentTarget)
      );
      li.appendChild(btn);
...
nextBtn.addEventListener('click', () => {
  currentQuiz++;
  progressEl.innerText = `진행도 ${currentQuiz}/${currentQuizData.length}`; // 진행도 업데이트
  resultContainer.style.display = 'none'; // 정답 결과 창을 끕니다
  quizContainer.style.display = 'block'; // 퀴즈 창을 킵니다
  if (currentQuiz < currentQuizData.length) {
    loadQuiz();
  } else {
    showFinalResult();
...
function showFinalResult() {
  ...
  menuBtn.innerText = '메인 화면'; // <로 되어 있는 메인 화면 버튼의 글자를 바꿉니다
  menuBtn.className = 'actionBtn'; // 클래스를 바꾸어서 그 클래스에 맞는 css 디자인으로 바꿉니다
  ...
  ${categoryNames[currentCategory]} 퀴즈 (${getDifficultyText(
    currentDifficulty
  )}) 에서 총 ${
    currentQuizData.length
  }문제 중 ${score}문제를 맞추셨어요. \n 계속 도전해보세요!`; // 결과를 알려줍니다
  footer.appendChild(rankingBtn); // 퀴즈 하단에 버튼 표시

  class LottiUI {
    // 폭죽 효과에 대해 기본적으로 세팅합니다
    constructor(x, y) {
  ...
  new LottiUI(window.innerWidth / 2 - 200, window.innerHeight / 2 - 200); // 폭죽 효과를 x,y를 입력후 실행합니다
