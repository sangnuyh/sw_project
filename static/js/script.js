const quizData = {
  ...
  commonSense: [
    ...
    {
      question: "유니온숍 제도에 대한 설명 중 틀린 것은?",
      options: ["노동자의 가입이 의무화 되어 있다.", "사용자의 임의로 탈퇴한 근로자를 해고할 수 있다.", "사용자가 근로자를 자유롭게 고용할 수 있다.", "유니온숍 제도는 노동자의 권리를 강화하기 위해서 도입된 제도이다."],
      answer: "사용자의 임의로 탈퇴한 근로자를 해고할 수 있다.",
      difficulty: "hard"
    },
    {
      question: "다음 중 프랑크푸르트 학파가 아닌 학자는?",
      options: ["마르쿠제", "발터벤야민", "루이 알튀세", "위르겐 하버마스"],
      answer: "루이 알튀세",
      difficulty: "hard"
    },
    {
      question: "다음 중 이황에 대한 설명 중 옳지 않은 것은?",
      options: ["조선 후기 영남학파의 이론적 토대를 마련했다.", "도산서원을 짓고 ‘성학십도’를 저술하였다.", "이기호발설과 ‘사단’은 ‘칠정’속에 포함될 수 없다고 주장하였다.", "이황은 실천을 중시하였다."],
      answer: "이황은 실천을 중시하였다.",
      difficulty: "hard"
    },
    {
      question: "서킷 브레이커란 종합주가지수가 전일에 비해 몇% 이상 하락한 상태가 1분이상 지속되는 경우에 주식거래를 중단시키는가?",
      options: ["5%", "7%", "10%", "15%"],
      answer: "10%",
      difficulty: "hard"
    },
    {
      question: "1817년 ‘적과 흑’의 작가 이름이자, 유명 예술 작품을 보다가 순간적으로 기절을 하거나 정신 착란을 일으키는 증상을 일컫는 말은?",
      options: ["스탕달", "발자크", "밧세바", "스칼렛"],
      answer: "스탕달",
      difficulty: "hard"
    },
    {
      question: "다음 중 수도와 국가의 연결이 틀린 것은?",
      options: ["카타르 - 테헤란", "이라크 - 바그다드", "이집트 - 카이로", "리비아 - 트리폴리"],
      answer: "카타르 - 테헤란",
      difficulty: "hard"
    },
    {
      question: "오징어 2축, 고등어 한 손, 마늘 한 접의 수를 다 합치면 얼마인가?",
      options: ["103", "122", "142", "152"],
      answer: "122",
      difficulty: "hard"
    },
    {
      question: "다음 중 고갱의 작품이 아닌 것은?",
      options: ["황색그리스도", "타히티의 여인들", "캔버스 앞의 자화상", "아를의 침실"],
      answer: "아를의 침실",
      difficulty: "hard"
    },
    {
